...
class OphCiAnaesthesiarecordModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCiAnaesthesiarecord.models.*',
			'OphCiAnaesthesiarecord.components.*',
		));

		$this->moduleShortSuffix = "anaesthesiarecord";
	}
